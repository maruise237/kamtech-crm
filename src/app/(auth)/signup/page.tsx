        ...
        <Card className="w-full max-w-md border-slate-800 bg-slate-900">
          <CardHeader className="items-center text-center">
            ...
            <CardDescription className="text-slate-400">
              ...
              <span className="text-white">{email}</span>. Ouvrez votre boite
              mail et cliquez sur le lien pour verifier votre compte.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link href="/login">
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-950 px-4">
      <Card className="w-full max-w-md border-slate-800 bg-slate-900">
        <CardHeader className="items-center text-center">
          ...
          <CardTitle className="text-xl text-white">Creer un compte</CardTitle>
          <CardDescription className="text-slate-400">
            Demarrez avec Kamtech CRM
          </CardDescription>
        </CardHeader>
        <CardContent>
