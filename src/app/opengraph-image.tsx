  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span>Pilotez vos ventes WhatsApp depuis&nbsp;</span>
          <span style={{ color: '#a78bfa' }}>un seul espace.</span>
        </div>
        ...
        >
          Conversations, contacts, pipelines, campagnes et automatisations reunis dans Kamtech CRM.
        </div>
