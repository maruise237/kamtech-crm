    ...
    <div className="w-full overflow-hidden rounded-2xl border border-slate-800 bg-slate-950 shadow-2xl">
      ...
      <div className="space-y-3 p-4">
        <div className="grid grid-cols-3 gap-2">
          {[
            { label: 'Convos ouvertes', value: '42', delta: '+5', positive: true },
            { label: 'Nouveaux', value: '18', delta: '+3', positive: true },
            { label: 'Rep. moy.', value: '3.2m', delta: '-0.4m', positive: true },
          ].map((s) => (
            <div
              key={s.label}
