      ...
      <div className="mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-12 px-6 py-20 sm:py-28 lg:grid-cols-2 lg:gap-16">
        <div>
          ...
          <h1 className="mt-5 text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Pilotez vos ventes WhatsApp depuis{' '}
            <span className="text-violet-400">un seul espace.</span>
          </h1>

          <p className="mt-5 max-w-xl text-base text-slate-400 sm:text-lg">
            Kamtech CRM regroupe conversations, contacts, pipelines,
            campagnes et automatisations pour aider votre equipe a repondre
            plus vite et mieux convertir chaque opportunite.
          </p>
